...
## Tech Stack
- **CV / Detection:** YOLOv7 (ultralytics), OpenCV
...
2. **Player Detection** (`pipeline/detect.py`)
   - Input: frames
   - Model: YOLOv7 fine-tuned weights from `models/weights/`
